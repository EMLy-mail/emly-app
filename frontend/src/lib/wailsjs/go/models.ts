...
export namespace main {
	...
	export class UpdaterIPCStatus {
	    Active: boolean;
	    Valid: boolean;
	    Meta: updateripc.IPCMeta;
	
	    static createFrom(source: any = {}) {
	        return new UpdaterIPCStatus(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.Meta = this.convertValues(source["Meta"], updateripc.IPCMeta);
	    }
...
export namespace updateripc {
	...
	export class IPCMeta {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.RequestProtocolVersion = source["RequestProtocolVersion"];
	        this.RequestSenderVersion = source["RequestSenderVersion"];
	        this.ResponseProtocolVersion = source["ResponseProtocolVersion"];
	...
	export class ADStatus {
	    ...
	    static createFrom(source: any = {}) {
	        return new ADStatus(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.ADDomain = source["ADDomain"];
	        this.DomainJoined = source["DomainJoined"];
	        this.Meta = this.convertValues(source["Meta"], IPCMeta);
	    }
