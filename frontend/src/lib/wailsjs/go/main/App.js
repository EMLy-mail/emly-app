 ...
 * +page.ts).
 */
export function GetAttachmentData(filePath, index) {
  return window['go']['main']['App']['GetAttachmentData'](filePath, index);
}
 ...
 *   - error: Error if loading or saving config fails
 */
export function SetLogStartupTrace(enabled) {
  return window['go']['main']['App']['SetLogStartupTrace'](enabled);
}
 ...
 *   - error: Error if loading or saving config fails
 */
export function SetOldAttachmentPreload(enabled) {
  return window['go']['main']['App']['SetOldAttachmentPreload'](enabled);
}
 ...
 */
export function TraceStartupStep(step, detail) {
  return window['go']['main']['App']['TraceStartupStep'](step, detail);
}
