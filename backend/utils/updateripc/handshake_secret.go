...
// and the server's PID/path check (verifyClient), not a replacement for
// either.
//
// THIS MUST STAY IDENTICAL, BYTE FOR BYTE, to
// emly-updater/internal/ipc/handshake_secret.go. There is no shared Go
...
// ClientAuthResponse fail HMAC verification and rejects this client.
